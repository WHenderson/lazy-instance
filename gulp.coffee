...
gulp.task('dist-git', ['dist-version'], (cb) ->
  ...
  exec('git add -f dist/lazy-instance.coffee')
  exec('git add -f dist/lazy-instance.node.js')
  exec('git add -f dist/lazy-instance.umd.js')
  exec('git add -f dist/lazy-instance.umd.min.js')
  exec('git add -f dist/lazy-instance.web.js')
  exec('git add -f dist/lazy-instance.web.min.js')
